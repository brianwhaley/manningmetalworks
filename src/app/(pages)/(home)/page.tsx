	...
	return (
		<>
			<PageSection columns={1} maxWidth="1024px" id="home-section">
				...
				<div className="scrollFadeElement" suppressHydrationWarning>
					<p>
